...
// Property routes (main real estate listings)
router.get('/properties', checkMaintenanceMode, getPropertyController);
router.get('/properties/:propertyId', checkMaintenanceMode, getSinglePropertyController);
router.post('/properties', checkMaintenanceMode, authToken, addPropertyController);
router.get('/user-properties', checkMaintenanceMode, authToken, getUserPropertiesController);
