...
const SecurityProvider = ({ children }) => {
  useEffect(() => {
    ...
    const setSecurityMeta = () => {
      ...
      cspMeta.content = "default-src 'self'; script-src 'self' 'unsafe-inline' https://www.googletagmanager.com https://www.google-analytics.com https://js.stripe.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com; img-src 'self' data: https: blob:; media-src 'self' blob: http://localhost:8080 https://res.cloudinary.com; connect-src 'self' http://localhost:8080 https://api.cloudinary.com https://res.cloudinary.com https://adoorealestate.onrender.com https://adoor-real-estate.onrender.com https://adoo-real-estate.onrender.com https://api.stripe.com https://www.google-analytics.com; frame-src 'self' https://www.youtube.com https://www.youtube-nocookie.com https://player.vimeo.com https://www.dailymotion.com https://js.stripe.com; object-src 'none'; upgrade-insecure-requests";
