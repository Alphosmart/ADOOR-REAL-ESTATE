        ...
        <div className={`min-h-screen bg-gradient-to-br ${maintenanceContent.backgroundColor} flex items-center justify-center px-4 sm:px-6 lg:px-8`}>
            <div className="max-w-md w-full bg-white rounded-lg shadow-xl p-8 text-center">
                ...
                <button
                    ...
                    className="w-full bg-accent-600 hover:bg-accent-700 text-white font-medium py-3 px-4 rounded-lg transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
                >
