                                ...
                                {images.slice(0, 4).map((img, index) => (
                                    <img
                                        ...
                                        className={`h-24 object-cover rounded cursor-pointer ${
                                            activeImage === index ? 'border-4 border-blue-600' : 'border border-gray-300'
                                        }`}
                                    />
                                ))}
                            </div>
                    ...
                    <div className="sticky top-4">
                        ...
                        <div className="bg-white border rounded-lg p-6 mb-4 shadow-md">
                            ...
                            <button 
                                ...
                                className="w-full bg-blue-600 text-white py-3 rounded-lg hover:bg-blue-700 mb-2 flex items-center justify-center"
                            >
