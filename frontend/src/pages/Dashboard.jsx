  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600 mt-2">Welcome to your real estate business admin dashboard. Here's an overview of your property listings and client inquiries.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          ...
          <div className="mt-4">
            <div className="flex items-center text-sm text-gray-600">
              <span className="text-gray-500">{stats.products.sold} archived</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          ...
          <div className="mt-4">
            <div className="flex items-center text-sm text-gray-600">
              <span className="text-gray-500">{stats.users.general} registered users</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <span className="text-sm font-medium text-gray-600">Archived Listings</span>
