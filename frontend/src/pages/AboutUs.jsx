          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-700 mb-4 leading-relaxed">
                ...
                properties, real estate services, professional consulting, and comprehensive property management solutions.
              </p>
        ...
        <section className="mb-16">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              To democratize property investment by providing accessible, premium real estate properties and décor 
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg shadow-lg p-6 text-center">
              ...
              <p className="text-gray-600">
                Our clients are at the heart of everything we do. We strive to provide exceptional 
                service and support throughout their property search journey.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-lg p-6 text-center">
              ...
              <p className="text-gray-600">
                ...
                cultural exchange through beautiful property investments.
              </p>
            </div>
          </div>
        </section>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">
                      Carefully selected properties curated by our professional team.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">
                      SSL encryption, secure payment processing, and client protection policies.
                    </p>
                  </div>
                </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-500 text-sm">
                Our executive team brings decades of experience in e-commerce, property investment, 
        ...
        <section className="text-center">
          <div className="bg-gradient-to-r from-blue-600 to-purple-700 rounded-2xl text-white p-8 md:p-12">
            ...
            <p className="text-xl mb-8 opacity-90">
              Join thousands of satisfied clients who have found their dream properties 
              through our professional real estate services.
            </p>
