                                ...
                                <div>
                                    <label className="flex items-center">
                                        <input
                                            ...
                                            className="rounded border-gray-300 text-accent-600 shadow-sm focus:border-accent-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50"
                                        />
                                ...
                                <div className="border rounded-lg p-4">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <p className="text-sm text-gray-600 bg-gray-50 border rounded-md p-3">
                                            The phone, email and address shown in the footer come from the <strong>Contact Us Page</strong> tab, so you only need to update them there.
                                        </p>
                                    </div>
                                </div>
